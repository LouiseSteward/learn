...
{% include figure
  ...
  <tbody>
   ...
   caption="Table 4-1: Essential items in an outbreak setting"
   description="Table 4-1: Essential items in an outbreak setting"
   class="wide"
%}
...
|----------------------------------+-------------------+--------------------+-------+-----------+----------------+-------------+---------+--------------------+-------|"
   caption="Table 4-2: Appropriate PPE for different support services areas"
   description="Table 4-2: Appropriate PPE for different support services areas"
   class="wide"
%}
...
{% include figure
  ...
  <tbody>
   ...
   caption="Table 4-3: Preferred workflow for an Ebola Treatment Unit"
   description="Table 4-3: Preferred workflow for an Ebola Treatment Unit"
   source=""
