...
The patient should carry a hand-held antenatal record or Maternity Case Record which contains all her antenatal information. This is a simple, cheap and highly effective method of recording patient information when caring for low-risk patients. Most patients look after their cards and take them along to the clinic. It is uncommon for patients to lose their cards. This system avoids the frustrating situation where the patient presents at a clinic or hospital, but her folder is being kept elsewhere. Using an antenatal record or Maternity Case Record instead of a hospital or clinic folder also shortens the time the patient has to wait at the clinic and reduces the workload of the staff. If a hand-held antenatal record or Maternity Case Record is used, there is no need to issue hospital or clinic folders before being seen at antenatal clinics and being admitted in labour.
