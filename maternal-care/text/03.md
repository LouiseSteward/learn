...
1. Give a simple classification of the hypertensive disorders of pregnancy.
1. Diagnose pre-eclampsia and chronic hypertension.
1. Explain why the hypertensive disorders of pregnancy must always be regarded as serious.
1. List which patients are at risk of developing pre-eclampsia.
1. List the complications of pre-eclampsia.
1. Differentiate pre-eclampsia from pre-eclampsia with severe features.
1. Give a practical guide to the management of pre-eclampsia.
1. Provide emergency management for eclampsia.
1. Manage gestational hypertension and chronic hypertension during pregnancy.
...
The common forms of hypertension during pregnancy that will be discussed in this chapter are:
...
2.	*Pre-eclampsia with signs of severe disease*: Any of the following:
	...
	*   {:.allow-break}*Pre-eclampsia with abnormal laboratory results indicating severe disease*: Any one of the following:
...
### 3-26 What should you do if a patient with pre-eclampsia develops features of severe disease?
...
The management of patients with pre-eclampsia with features of severe disease (severe features) consists of stabilising the patient, followed by referral to a level 2 or 3 hospital.
...
*	Give 10 mg (1 capsule) nifedipine orally or 5 mg dihydralazine slowly intravenously.
...
6.	{:.tighten-10}A platelet count and renal function tests (urea and creatinine) must be done twice a week. If the platelet count is less than 100 000, liver function tests should be done. Poor renal function, raised liver enzymes or a platelet count that falls further are indications for delivery.
...
Increased tendon reflexes are a sign of pre-eclampsia with severe features. The diagnosis must be made, irrespective of the degree of hypertension or the amount of proteinuria. To prevent the development of eclampsia, the patient must be given magnesium sulphate.
