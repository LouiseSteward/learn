...
Note
: A BMI of less than 18.5 indicates that the woman is underweight and possibly undernourished and a BMI of 40 or more indicates morbid obesity. An MUAC of less than 18 cm indicates possible undernutrition and more than 33 cm indicates obesity. If the MUAC is more than 33 cm a wide cuff (17.5 cm) must be used to measure the blood pressure.
...
3.	Thereafter every 2 weeks until 40 weeks (i.e. 36, 38 and 40 weeks). 
...
Note
:	WHO option B+, rolled out in 2012, recommended a fixed drug combination (FDC) to be used as a once a day single tablet. FDC consists of tenofovir, emtricitabine and efavirenz. In 2019 FDC was replaced by a new fixed drug combination (TLD) consisting of tenofovir, lamivudine and dolutegravir.

### 1-67 What is antiretroviral treatment?

The aim of ARV treatment is to lower the viral load and allow the immune system to recover. This will both reduce the risk of HIV transmission to the infant and to treat the mother's HIV infection. The ARV treatment of choice consists of taking tenofovir (TDF) 300 mg, lamivudine (3TC) 300 mg and dolutegravir (DTG) 50 mg as a single fixed dose combination (TLD) tablet daily.
...
*	If known to have a viral load that was not suppressed or if no viral load result is available, they should be started on zidovudine (AZT), lamivudine (3TC) and dolutegravir (DTG).
