...
All information relating to the pregnancy must be entered in a patient-held Maternity Case Record. The antenatal card Maternity Case Record can also serve as a referral letter if a patient is referred to the next level of care and therefore serves as a link between the different levels of care as well as the antenatal clinic and labour ward.
...
Note
: The BMI is calculated by dividing the weight in kg by the length in meters squared. A BMI of less than 18.5 indicate possible malnutrition and a BMI of 40 or more morbid obesity. A MUAC of less than 18 cm indicate possible malnutrition and more than 33 cm. If the MUAC is more than 33 cm a wide cuff (17.5 cm) must be used to measure the bold pressure.
...
All risk factors must be entered on the problem list on the fundal height graph and follow-up visits of the antenatal record. The management needed should be entered opposite the gestational age at the top of the card, e.g. a glucose profile or umbilical artery Doppler need to done at 26 weeks if indicated.
...
7.	A glucose profile needs to be done on all women at risk for gestational diabetes, e.g. age 40 years of more, a BMI of 40 or more, previous gestational diabetes, previous big babies (above 4.5 kg), previous shoulder dystocia or a previous stillbirth of unknown cause.
...
On the page of the Maternity Case Record for the patient's personal details, history, estimated gestational age, examination findings, results of the special investigations, plan of management, and proposed future family planning. The next page that contains the fundal height growth curve are for all the maternal and fetal observations made during pregnancy.
...
For treatment a fixed dose combination (TLD) pill is taken daily, usually at bedtime.
...
The aim of ARV treatment is to lower the viral load and allow the immune system to recover. This will both reduce the risk of HIV transmission to the infant and to treat the mother's HIV infection. ARV treatment of choice consists of taking tenofovir (TDF) 300 mg, lamivudine (3TC) 300 mg and dolutegravir (DTG) 50 mg as TLD a single tablet daily.

Women diagnosed with HIV infection for the first time must commend on TLD. Women who are already on a different ARV treatment with a lower than detectable viral load (VL) when they book for antenatal care should be switched to TLD. Women previously exposed to ARV, but not currently taking ARVs must be:

*	If known to have a suppressed VL while on ARVs they should be commenced on TLD.
*	If known to have VL that was not suppressed or if no VL result available should be commenced on zidovudine (AZT), 3TC and DTG.
...
TB is treated with four drugs (rifampicin, isoniazid, pyrazinamide and ethambutol). Rifampicin results in more rapid metabolisation of DTG. DTG need to boosted by providing an additional 50 mg of DTG 12 hours apart from taking TLD. Treatment of both HIV and tuberculosis should be integrated with routine antenatal care whenever possible.
...
Because hypertension in a previous pregnancy places her at high risk of hypertension again in this pregnancy. She must be carefully examined for hypertension and proteinuria at this visit and at each subsequent visit. If she develops either hypertension or proteinuria she need to be referred for level 2 care. This case stresses the importance of a careful history at the booking visit.
