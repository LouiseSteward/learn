...
3.	Recordings made during the first hour after the delivery of the placenta:
	...
	*	If normal after one hour, the observations must be repeated every 30 minutes for the 2<sup>nd</sup> hour.
...
Note
:	The need for a total abdominal hysterectomy may have to be considered.
