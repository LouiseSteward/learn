...
1.	A shocked patient should have 2 intravenous infusion lines with Plasmalyte B or Ringer’s lactate running in fast. Trained ambulance personnel and if not available a doctor should accompany the patient if possible. If not possible, a registered nurse should accompany her. 
2.	A patient who is no longer bleeding should also have an intravenous infusion and be accompanied by trained ambulance personnel and if not available a registered nurse whenever possible. 
{:.allow-break}
