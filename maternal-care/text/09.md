...
2.	{:.allow-break}If a primigravida has inadequate uterine contractions and there are no signs of cephalopelvic disproportion (i.e. 2+ moulding or less), an oxytocin infusion should be started. Only one unit of oxytocin should be used as described in Section 8-37. When strong contractions are obtained, the patient must start bearing down.
...
4.	Uterine contractions in the second stage of labour are strong and occur at a high frequency. Suppressing uterine contractions as described in Section 8-34 is beneficial to both the mother and fetus. 
