...
> This module is updated as new research and best practice becomes available. We&nbsp;recommend checking back regularly. Major changes will be listed here. This module was last updated on {{ site.time | date: '%-d %B %Y' }}.
...
Note
: A number of molecular tests, such as polymerase chain reaction (PCR) tests, are being used to identify the SARS-CoV-2 virus. What is needed is a rapid on-site test. An antibody test would confirm the infection as soon as the person mounts an immune response. It would also identify people who have recovered from an infection.
