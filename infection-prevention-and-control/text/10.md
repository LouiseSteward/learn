...
Note
: ‘Ro’ is the reproductive ratio or the number of people that an infected person is likely to infect. COVID-19 has a Ro of 3. The higher the Ro of a virus the more infectious it is. The aim of population management is to reduce the Ro to less than one, so that the viral transmission chain is interrupted.
...
Note
: Only when detailed surveys of infection rates in different communities are done will the true mortality rate of COVID-19 be known as the number of asymptomatic cases in different age groups and social classes remains uncertain.
...
Note
: A number of molecular tests are being used to identify the SARS-CoV-2 virus. An antibody test would confirm the infection as soon as the person mounts an immune response. It would also identify people who have recovered from an infection.
...
> A blood test for antibodies will be able to identify people who have recovered from the coronavirus infection.
...
> Handwashing, respiratory hygiene, social distancing and self-isolation at home are the most important ways to prevent the spread of coronavirus.
...
> Social distancing helps avoid spreading and becoming infected with the coronavirus.
...
> Self-isolation at home is an essential step to avoid getting infected and slow down the spread of the pandemic.
...
> Every effort must be made to ‘flatten the curve’ and slow the spread of coronavirus.
...
Note
: The aim of containment or community lockdown is to reduce the reproductive ratio (Ro) i.e. the number of people that an infected person is likely to infect.
...
> People who are well but have suspected COVID-19 or who have been exposed to someone with COVID-19 should be quarantined at home and self-monitor.
...
> Only people with respiratory symptoms plus a history of exposure to coronavirus should be screened.
...
> Most people with mild COVID-19 can be managed at home with self-quarantining and self-monitoring.
...
Note
: If the availability of ICU facilities and ventilators is overwhelmed by the number of patients a system of triage will be needed. In this tragic circumstance a clearly understood and agreed upon protocol of who gets admitted for intensive care must be developed.
