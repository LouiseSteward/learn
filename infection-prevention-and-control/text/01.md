...
### 1-11 What are the World Health Organisation’s recommended core components for the implemention of infection prevention and control in health facilities?
...
6.	Monitoring, evaluation and feedback: A national monitoring and evaluation programme of key performance indicators, such as hand hygiene, should determine whether IPC standards are met and activities performed. Relevant staff should receive regular feedback of the assessments.
...
A cycle of continuous improvement can be achieved by followed these five steps:
