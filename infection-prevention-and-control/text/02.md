...
{% include figure
  ...
  <tbody>
   ...
   caption="Table 2-1: Bacteria as classified by their staining pattern."
   description="Table 2-1: Bacteria as classified by their staining pattern."
...
{% include figure
  ...
  <tbody>
   ...
   caption="Table 2-2 The main routes by which micro-organisms can be spread"
   description="Table 2-2 The main routes by which micro-organisms can be spread"
   class="wide"
%}
...
{% include figure
  ...
  <tbody>
   ...
   caption="Table 2-3: The main host defence mechanisms"
   description="Table 2-3: The main host defence mechanisms"
   class="wide"
%}
...
{% include figure
  ...
  <tbody>
   ...
   caption="Table 2-4: Factors increasing the likelihood of hospital acquired infections (HAI)."
   description="Table 2-4: Factors increasing the likelihood of hospital acquired infections (HAI)."
   source="Adapted from S Mehtar: *Understanding Infection Prevention and Control*, Juta, 2010."
   class="wide fixed"
%}
