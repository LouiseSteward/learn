...
* cohort isolation: placing two or more patients with the same disease (caused by the same micro-organism) together in isolation."
   caption="Table 3-2: Transmission-based precautions for the three major routes of transmission"
   description="Table 3-2: Transmission-based precautions for the three major routes of transmission"
...
{% include figure
   markdown="| Procedure                  | Hand hygiene    | Gloves            | Aprons          | Masks           | Eye covers            |
|----------------------------+-----------------+-------------------+-----------------+-----------------+-----------------------|
| IV cannulation             | ✓               | ✓                 |                 |                 |                       |
...
| Lumbar puncture            | ✓               | ✓ Sterile         | ✓ Sterile gown  | ✓               |                       |"
   caption="Table 3-3: Appropriate use of personal protective equipment (PPE) for common procedures"
   description="Table 3-3: Appropriate use of personal protective equipment (PPE) for common procedures"
   source="Adapted from Z cards, S. Mehtar, 2010"
   class="wide"
%}
...
|---------------------------+------------+------------+----------+-----------|"
   caption="Table 3-4: Example of bundle compliance"
   description="Table 3-4: Example of bundle compliance"
   source="Adapted from the Institute for Healthcare Improvement (IHI)"
   class="wide"
%}
