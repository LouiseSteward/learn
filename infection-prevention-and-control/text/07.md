...
| Continuing source outbreak                                                             | Victims contract disease over multiple incubation periods (many people infected from others) e.g. chickenpox in a hospital ward                                                                                                       |"
   caption="Table 7-1: Terms used in outbreak investigation"
   description="Table 7-1: Terms used in outbreak investigation"
   class="wide"
%}
...
|---------+------------+----------------------------------------------------------+-------------------------+-----------------+---------------------------------+----------------------+---|"
   caption="Table 7-2: Example of a line list"
   description="Table 7-2: Example of a line list"
   class="wide"
%}
...
{% include figure
   markdown="| Case number | Age (years) | Gen&shy;der | Ad&shy;mission date | Oper&shy;ation date  | Dia&shy;betic | Sur&shy;gical pro&shy;cedure | Peri-opera&shy;tive blood sugar | Day of symp&shy;tom onset | Organ&shy;ism on wound swab   |    Sus&shy;cepti&shy;bility pro&shy;file    | Sur&shy;geon |        Out&shy;come        |
|-------------+-------------+-------------+---------------------+----------------------+---------------+------------------------------+---------------------------------+---------------------------+-------------------------------+---------------------------------------------+--------------+----------------------------|
...
*CABG = Coronary artery bypass graft*"
   caption="Table 7-3: Line list for mediastinitis cases"
   description="Table 7-3: Line list for mediastinitis cases"
   class="wide"
%}
