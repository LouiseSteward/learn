...
*See [appendix E](appendix-e.html) for a detailed breakdown of the QUESTT approach.*
...
*See [appendix E](appendix-e.html) for examples of the different age appropriate pain rating scales available.*
...
*See [appendix F](appendix-f.html) for formulary and doses.*
...
*See [appendix F](appendix-f.html) for a table of co-analgesia, which includes the list of medications that will assist in treating these various difficult pains.*
