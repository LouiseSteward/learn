...
<span class="highlighter">**Note to Dave and authors: please update the reference which follows as this table is no longer provided within the appendices. We can point to appendix H (the drug formulary) or link to the table of co-analgesia on the source site, if preferred.**
<br>*See [appendix F](appendix-f.html) for a table of co-analgesia, which includes the list of medications that will assist in treating these various difficult pains.*
</span>
