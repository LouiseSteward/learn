...
Note
: It has been recommended that due to it being so common, pain should be assessed alongside the other vital signs, namely blood pressure, pulse, respiration and temperature. It should be recognised as the 5^th^ vital sign.
...
> The WHO broad principles of analgesia use by the appropriate route, by the clock, by the child and by the ladder.

Note
: The recent World Health Organization guidelines for the management of pain in children have proposed a two step ladder removing weak opioids and replacing this with low dose morphine. In South Africa because of the availability of Tilidine (Valoron) we prefer to use the three step ladder.
...
- Anti-convulsants e.g. carbamazepine, gabapentin, pregabalin
- NMDA-receptor channel blockers e.g. ketamine
- Alpha beta blocker e.g. clonidine
...
### 5. How would you interpret a FLACC score of 8 out of 10 for Nosipho?
...
### 7. What other information about the common side effects would need to be explained to the family? 
