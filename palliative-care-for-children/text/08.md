...
*See [appendix H](13-appendix-h.html) for formulary and doses.*
...
<div class="highlighter">**Note to Dave and authors: please update the reference which follows as this table is no longer provided within the appendices. We can point to appendix H (the drug formulary) or link to the table of co-analgesia on the source site, if preferred.**
