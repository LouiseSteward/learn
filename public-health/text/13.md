...
 
Note
:    You can find the National Core Standards at: 
http://www.dhasa.co.za/wp-content/uploads/2017/11/2.-National-Core-Standards-Fasie-Smith-Advanced-Health.pdf 
...
Useful organisations which can help with advocacy procedures are listed in Appendix 4.
...
Good major incident planning involves several stages that go beyond just a response plan. This is often called the “disaster life cycle”.  It is a very useful way of handling both disasters and major incidents. With good planning it may be possible to convert a potential disaster into a major incident, which is manageable. Both may also be avoided by risk identification and reduction (figure 30-1).
...
Figure 30-2: Summary of the hospital response framework used in H-MIMMS. 

> ![Figure 30-2: Summary of the hospital response framework used in H-MIMMS.]({{ images }}/30-2.svg)
> 
> Figure 30-2: Summary of the hospital response framework used in H-MIMMS. 
{:.figure}
