...
An example of a complex system is an ecosystem such as a pond or a forest, but the thinking behind complex systems is being increasingly used to explain the difficult problems in health and healthcare. A healthcare system can be shown as a complex system in Figure 15-2 healthcare.

> ![Figure 15-2: ]({{ images }}/15-2.svg)
> 
> Figure 15-2: 
{:.figure} 
