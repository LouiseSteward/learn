...
1.	{:.allow-break}Two sputum samples should be sent for testing for acid-fast bacilli (i.e. TB bacteria). If available, a GeneXpert test should be done on 1 sample. GeneXpert is a rapid and sensitive method of detecting TB bacilli in sputum. It can also determine if the TB bacilli are resistant to rifampicin. If the GeneXpert or smear results are positive the patient should be started on TB treatment. Where GeneXpert is available, if it is positive, the second sample will be used for smear microscopy. Smear-positive patients have pulmonary tuberculosis and are infectious.
