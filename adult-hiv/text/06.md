...
1.	{:.allow-break}Two sputum samples should be sent for testing for acid-fast bacilli (i.e. TB bacteria). If available, a GeneXpert test should be done. GeneXpert is a rapid and sensitive method of detecting TB bacilli in sputum. It can also determine if the TB bacilli are resistant to rifampicin. If the GeneXpert or smear result is positive, the patient should be started on TB treatment.
...
As there are complex interactions between the drugs used to treat TB and the drugs used for antiretroviral treatment, the management of these patients may need to be reviewed by a doctor experienced in managing patients with TB and HIV co-infection.
