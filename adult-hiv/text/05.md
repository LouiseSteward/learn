...
7.  The patient is given one month’s supply of drugs by the pharmacist.
...
If prescribed, co-trimoxazole prophylaxis will be continued until the CD4 count is above 200 cells/µl. This usually implies that prophylaxis is continued for at least the first six months of antiretroviral treatment.
...
The CD4 count should increase. People with CD4 counts below 200 cells/µl may expect an increase of 80 percent or more.
...
The feature of treatment failure after four to six months on antiretroviral therapy is a viral load above 1000 copies/ml, on at least two occasions, at least 2 months apart.
...
Note
:	Treatment failure is defined as two viral loads above 1000 copies/ml taken at least 2 months apart.
...
Note
:	Check hepatitis B status before changing from a first line containing TDF as TDF and 3TC/FTC are also used to treat hepatitis B. If patient is Hep B surface antigen positive maintain patients on TDF and 3TC/FTC i.e. the second-line regimen will be TDF + AZT + 3TC or FTC + Aluvia (four drugs, not three).
...
The schedule of visits is the same as that for the first-line combination with a commencement visit followed by visits at one and two but they should also have a visit at month three to check fasting cholesterol and triglycerides. . Patients are then seen again at six months for a viral load, within a month for the viral load results. They can then be seen every 3 to 6 months. followed by three-monthly visits.
...
Yes. If the patient vomits up the pills or tablets, the dose should be taken again as soon as possible. Vomiting more than one hour after taking the medication is probably not important, and so the dose does not need to be taken again.
...
Treatment failure is diagnosed when antiretroviral treatment fails to produce or maintain an adequate suppression of the viral load. There are two forms of treatment failure.

1.	1.   Treatment failure right from the start of treatment when the viral load does not fall as expected within six months.
...
Before diagnosing treatment failure it is important to repeat an initial high viral load (above 1000 copies/ml) after two to three months of adherence support and problem solving. The diagnosis of treatment failure is confirmed if the viral load remains high (above 1000 copies/ml) or increases further. Sometimes the viral load will be increased at the time of the first measurement but falls with the second measurement, especially if adherence education and support are provided. Therefore, always repeat the viral load after two to three months before diagnosing treatment failure. The only exception is if patients have a very low CD4 count, and you think they cannot wait 2 to 3 months before changing to second line. In this case, consult a specialist HIV clinican or call the HIV hotline.
...
This is the interference of one drug with another drug. Common examples of drug interactions are:
...
Usually at six months after starting treatment for viral load. However, he should immediately return to the antiretroviral treatment clinic if he experiences side effects or has other problems. In some services viral load is done at 4 months, and so the patient should return at month 5 for the viral load results.
...
If the antiretroviral treatment has been successful the patient may be seen every 2 to 4  months. However, he should continue to collect his medication regularly. His CD4 count and viral load should be measured at one year on treatment and he should continue to have a viral load test every year.
...
After treatment has been started an Hb and differential should be done at months three and six and then every 12 months to screen for anaemia, which is a common side effect of AZT. Fasting glucose, cholesterol and triglyceride should be measured at three months. These tests screen for metabolic abnormalities caused by lopinavir/ritonavir (Aluvia).
...
Taking less than 95 percent of doses. Even moderate adherence, when between 80 and 95 percent of doses are taken, is not satisfactory. The goal must be to take all doses at the correct time.
...
<table>
  ...
  <tr>
    ...
    <td>24 hours</td>
    <td>Skin rash (allergy), vivid dreams, dizziness, sleep changes in first four weeks</td>
  </tr>
</table>
