...
# **3A** Skills: Clinical history and examination
...
{% include figure
  ...
  <tr>
   ...
   caption="*Table 3-1: Guidelines for a detailed examination*"
   description="*Table 3-1: Guidelines for a detailed examination*"
   class="wide large"
%}
