...
For example, the mortality rate could be calculated only for children under 5 years of age who live in a specific town.

> Mortality rates are often calculated for a specific section of the population only.

### 1-5 What is the annual mortality rate?

This is the mortality rate calculated over the period of one year. Mortality is usually expressed as an annual rate. Sometimes the mortality rate may be expressed over a longer period such as 3 years.
...
No. The mortality rate often differs markedly between health districts. Usually the rates are higher for poor than industrialised districts. Similarly, rates are higher in low- and middle-income than in high income  countries.
...
1.	Maternal mortality rate (women who die within 42 days  after pregnancy).
2.	Stillbirth rate (infants born dead > 22 weeks or > 500 g).
...
Note
:   Stillborn babies < 22 weeks or < 500 g if no gestation is available are usually classified as miscarriages. 
...
The primary cause of maternal and early neonatal deaths as well as stillbirths is the obstetric factor or condition which resulted in the death, i.e. it is the reason why the death occurred. For example, if a pregnant woman has a placental abruption and the fetus dies, the primary cause of the stillbirth is antepartum haemorrhage due to abruptio placentae. Similarly, a severe abruptio placentae could also be the primary cause of death of the mother. Knowing the primary causes of death helps to identify important medical conditions that need to be prevented and when clinical practices need to be improved.
...
This is an important document, which reports on the mortality audit. It gives the details of the audit and should also summarise the main findings and make recommendations. It is best to keep minutes of the mortality meeting when all the information is still available. Usually all the weekly or monthly minutes from one year are used to prepare an annual mortality report.
...
### 1-26 What is the role of the Perinatal Problem Identification Programme in recording maternal deaths?

The Perinatal Problem Identification Programme (PPIP) is a software package used mainly for recording data on perinatal deaths(discussed in more detail in chapter 4). The information from the PPIP database can be used to calculate important rates, such as the maternal, stillbirth, early neonatal death and perinatal mortality rates. Other analyses include the Caesarean section, low birth weight and teenage pregnancy rates. However PPIP is also very useful to record information and analyse maternal deaths. PPIP data helps to collect the documentation needed for the national confidential enquiry into maternal deaths.

### 1-27 What is morbidity?
...
### 1-28 Why is it important to document morbidity?
...
Note
:	In South Africa, the first confidential enquiry into maternal deaths was conducted in 1998. Since then, 7 triennial reports were published, the latest detailing deaths from 2014-2016.

## Birth register

### 1-31 What is a birth register?
...
### 1-32 What information should be recorded in the birth register?

1.	The mother's name, hospital or clinic number and age.
2.	Whether the mother had antenatal care.
3.	The mother's Rh, syphilis and HIV status.
...
Note
:	The HIV positive rate is a very important indicator to measure spread of the disease in each community and each woman’s HIV status may also be included in the register, provided that the result is kept strictly confidential.

## 1-33 What useful information can be calculated from information in a birth register?

1.	Teenage pregnancy rate.
2.	Rate of attending antenatal care ('booking rate').
3.	Syphilis and HIV prevalence.
...
### 1-34 What is a minimal data set?

This is the basic information that must be collected from the birth register at every clinic or hospital which conducts deliveries:
...
3.	Syphilis and HIV status of the mother (negative, positive or unknown). If possible, it is also important to record the HIV status of each mother.
...
### 1-35 What is the value of knowing the number of young and older mothers?
...
Older mothers have a higher rate of twins, infants with congenital abnormalities and underlying chronic diseases such as diabetes or hypertension.

### 1-36 Why measure the rate of women attending antenatal care?
...
### 1-37 Why is the number of women who are screened for syphilis important?
...
### 1-38 Why is the HIV prevalence determined?

The need for screening all women for HIV is very important, as monitoring the HIV prevalence in pregnant women is one of the best ways of documenting the spread of HIV in a community. The use of antiretrovirals reduce the risk of mother to child transmission of HIV and keeps the mother healthy. The management of pregnancy, labour and delivery, and of the newborn infant is different for HIV positive women.

A high rate of acceptance of HIV testing indicates a good antenatal care service.

### 1-39 What is the use of documenting the Caesarean section rate?

The Caesarean section rate in a low and middle income country (LMIC) should be about 15%. It will be much higher in a referral hospital. A low rate may indicate inadequate care in labour and can be associated with an increased number of deaths due to labour or postpartum complications. A very high rate usually indicates that many unnecessary Caesarean sections are being done. This may result in long waiting times for a theatre and unnecessary morbidity and mortality. 

### 1-40 Why is it important to document whether the mother has been referred during labour?
...
### 1-41 What is the use of knowing the rate of infants with birth hypoxia?

The percentage of infants with a low 5 minute Apgar score (i.e. neonatal asphyxia) is a useful index of care in labour. Many asphyxiated infants usually indicates poor labour care. The percentage of asphyxiated infants who die gives an idea of the standard of newborn resuscitation.

## Low birth weight

### 1-42 How may infants be divided into groups by their birth weight?
...
### 1-43 What is a low birth weight infant?
...
### 1-44 Why is it important to identify all low birth weight infants?
...
### 1-45 What is the low birth weight rate?
...
### 1-46 What is the importance of the low birth weight rate?

The low birth weight rate varies widely between different communities and is a very sensitive marker of the socioeconomic status of that community. In a high income country the low birth weight rate is usually around 7%. However, in a poor country the low birth weight rate is usually 15% or more (e.g. 30% in India). Knowing the low birth weight rate of different communities helps to identify those communities in greatest need of socioeconomic support.

> The low birth weight rate reflects the socioeconomic status of the community.

### 1-47 What is the low birth weight rate in South Africa?

The average low birth weight rate for South Africa is about 15% which is typical for a low- and middle-income country. In some very poor areas the low birth weight rate is as high as 25%.
...
At a regular monthly perinatal mortality meeting in a regional hospital, the information from the PPIP database is used to present an audit of maternal and perinatal care provided. Important items from the minimal data set are discussed.
{:.tighten-10}
...
This is the most important information which must be recorded in the birth register. It includes the number of maternal deaths, live births, stillbirths and early neonatal deaths, together with the method of delivery and important details of each woman, such as her age and syphilis and HIV status. The birth register also includes other less important information, which is usually not given in the minimum data set, such as the gender (sex) and Apgar score of each infant.

### 4. What is PPIP?

This is a software package that is used to enter and analyse data on perinatal morbidity.

### 5. What useful information can be calculated from the PPIP database?

The information from the PPIP database can be used to calculate important rates, such as the maternal, stillbirth, early neonatal death and perinatal mortality rates. Other analyses include the Caesarean section, low birth weight and teenage pregnancy rates.

### 6. What is the value of knowing the rate of women who attend for antenatal care?
...
In a health service consisting of one hospital and five clinics, the minutes of each monthly morbidity and mortality audit are used to write an annual mortality report. 

### 1. When are the monthly morbidity and mortality minutes written?

After all the morbidity and deaths are discussed at the monthly mortality meeting. At the meeting the number and causes of the morbidity and deaths are discussed. The mortality minutes is a summary of the mortality meeting.

### 2. What is an annual morbidity and mortality report?
...
### 3. What are the steps of a morbidity and mortality audit?
...
This is a detailed investigation into the cause and possible avoidable factors in a maternal death. It is confidential as the names of the staff who cared for the patient are kept secret. By keeping the personal details of the patient and the staff involved confidential, it is more likely that the true findings will be uncovered. Discussing maternal deaths and completing the NCCEMD maternal death notification form is a statutory requirement and must be done within one week of the death.

## Case study 4

The birth weight of each infant is recorded in the labour ward register. This same information is entered into the PPIP database as the monthly denominator data. The database can then calculate the low birth weight rate. 
...
### 4. What are the low birth weight rates in low-income and high-income countries?

Most poor countries have a low birth weight rate of 15% or more while the rate is usually about 7% in high income countries.
