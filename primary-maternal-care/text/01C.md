...
1.	{:.allow-break}*At the first visit*:
...
2.	{:.allow-break}*At subsequent antenatal visits*:
...
3.	{:.allow-break}*Immediately before labour*:
...
1.	{:.allow-break}*Antepartum haemorrhage*. However, there are two exceptions to this rule:
...
1.	{:.allow-break}The bladder must be empty.
