...
1.	NVP is called Viramune.
2.  EFV is called Stocrin.
...
1. For children younger than 4 weeks of age and below 3 kg body weight the first line combination is two ‘nucs’ together with a non-nuc. Therefore, the preferred combination is AZT and 3TC plus NVP. This combination is chosen because it causes few serious side effects during the neonatal period. 
...
3. For children less than 10 years of age and weighing between 20 and 35 kg, the first-line combination is two ‘nucs’ together with an ‘II’. A combination of ABC, 3TC and DTG is used. Therefore antiretroviral treatment for older children is usually started with a combination of ABC and 3TC plus DTG.
...
1. For children who fail a first-line regimen consisting of two ‘nucs’ plus EFV or neviraine, resistance testing is not required. The preferred second-line regimen consists of two ‘nucs’ + DTG. The two ‘nucs’ should be selected in consultation with an experienced clinician.
...
{:.wide .fixed}
\* NVP should be taken daily for the first 14 days. 
\*\* EFV is best taken on an empty stomach for the first few weeks.
...
ABC is a ‘nuc’ (trade name is Ziagen). ABC can be taken with or without food. The oral solution contains 20 mg/ml. The dose is 8 mg/kg/dose twice daily. Alternately, for children over 10 kg once daily dosing with 16 mg/kg/dose may be used.
...
3TC is also a ‘nuc’. 3TC is well tolerated and has very few side effects. Mild nausea, headache and diarrhoea may occur. 3TC can be taken with or without food. The dose is 4 mg/kg/dose twice a day. For children above 10 kg once daily dosing of 8 mg/kg dose can be used.
...
The dosing schedule for 3TC 300 mg and ABC 600 mg co-formulated tablets for children weighing 25 kg and above is one tablet daily. 3TC 300 mg is also included in a fixed dose combination with tenofovir 300 mg and DTG 50 mg (TLD) for use in adolescents weighing 35 kg and above.

### 4-35 How should AZT be taken?

AZT is a ‘nuc’ (trade name is Retrovir). AZT has many short-term minor side effects such as fatigue, nausea and vomiting, headache, muscle pains and altered taste. These are common at the start of treatment but become less after a few weeks. The most important side effect of AZT is anaemia.
...
NVP (trade name Viramune) is a ‘non-nuc’. An introduction dose of NVP is given once daily in the evening for 14 days. This may cause a mild erythematous (pink) or measles-like rash. If no rash occurs, a maintenance dose is given twice daily.
...
Note
:	NVP causes asymptomatic hepatitis in 10% and clinical hepatitis in 1% of adults. NVP plus TB treatment increases the risk of severe rash and hepatitis. Co-trimoxazole may rarely cause hepatitis. ‘Nucs’ may cause a fatty liver (steatosis).
