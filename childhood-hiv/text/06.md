...
1.	If NVP is being used, it should be replaced with efavirenz, which is less affected by rifampicin.
2.	If lopinavir/ritonavir is being used, it should be boosted with additional ritonavir to maintain adequate blood levels.
3.	If dolutegravir is used then change from daily dosing to twice daily dosing.
...
Rifampicin is the usual cause of adverse drug interactions when HIV and TB are treated at the same time. Rifampicin lowers the blood level of many drugs, especially NVP, lopinavir/ritonavir and dolutegravir. Therefore, NVP is usually swapped for efavirenz, extra ritonavir is added to the lopinavir/ritonavir treatment and dolutegravir dosing frequency is changed to twice daily. Not making these changes may lead to drug resistance and failure of antiretroviral treatment.
