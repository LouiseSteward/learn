...
Yes. It is best if both systems of staging are used together when deciding whether a child needs to be prioritized for rapid ART initiation. While the immunological staging indicates the degree of immunosuppression, the clinical staging indicates the effect of the immunosuppression. Both are important.

Note
:   The South African ART guidelines recommend that all HIV-infected individuals without contra-indications be initiated on ART within 7 days. Pregnant women, infants and children under five years and those with advanced disease should be prioritized for rapid initiation.
