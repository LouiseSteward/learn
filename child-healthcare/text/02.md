...
{% include figure
  ...
  <tr>
   ...
   caption="Table 2.1: The schedule for the immunisation of children in South Africa"
   description="Table 2.1: The schedule for the immunisation of children in South Africa"
   class="wide fix"
%}
...
{% include figure
  ...
  <tr>
   ...
   caption="Table 2-2: Summary of immunisations routinely used"
   description="Table 2-2: Summary of immunisations routinely used"
   class="wide fixed"
%}
