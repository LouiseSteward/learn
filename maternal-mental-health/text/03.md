...
If a woman or her partner misuses alcohol or drugs, she can get psychological support and information from special organisations that will deal with addiction problems (see [chapter 5](05.html) and the [Resources](08-resources.html) section for more information). In some settings, the protocol is to refer these families to a social worker. 
...
For details on how to apply for a Maintenance Order and what to do when payment is not made, go to the [Resources](08-resources.html) section.
...
Note
:	Details about these grants, as well as the process to follow to apply, are available in the [Resources](08-resources.html) section.
