...
{% include figure
  ...
  <tbody>
   ...
   caption="Guidelines for listening and responding"
   description="Guidelines for listening and responding"
   class="wide"
%}
...
{% include figure
  ...
  <tbody>
   ...
   caption="Responding appropriately"
   description="Responding appropriately"
   source="© Adapted from Liz Mills"
   class="wide"
%}
